...
in that screen's template (see itr1/templates/itr1/*.html)."""

from django.urls import reverse

_SCREEN_URL_NAMES = {
    'PERSONAL_INFO': 'itr1:personal_info',
    'GROSS_TOTAL_INCOME': 'itr1:gross_total_income',
    'TOTAL_DEDUCTIONS': 'itr1:total_deductions',
    'TAX_PAID': 'itr1:tax_paid',
    'TAX_LIABILITY': 'itr1:tax_liability',
    'TAX_SUMMARY': 'itr1:tax_summary',
    'VALIDATION': 'itr1:validation',
}
