...
RETURN_FILE_SEC_CHOICES = [
    ...
    # code for 139(8A) "updated return" at all -- see docs/SCHEMA_MAPPING_NOTES.md.
]
...
# itr1/serialize/importer.py (the CBDT-schema reader, which is ground truth
...
# ---------------------------------------------------------------------------
#
# Row-shape note: verified against itr1/serialize/importer.py, same as the
# Screen 3 note above:
