...
from infra.accounts.forms import (
    ChangePasswordForm,
    DeleteAccountForm,
    LoginForm,
    MfaDisableForm,
...
from infra.accounts.mfa import base32_secret, find_verified_device, get_or_create_setup_device, qr_data_uri
from infra.accounts.models import MfaEnrollment, get_profile, log_auth_event
from infra.accounts.ratelimit import check_and_increment, get_counter, increment_counter, reset_counter
...
class SignUpView(FormView):
    ...
    def form_valid(self, form):
        ...
        login(self.request, user, backend='infra.accounts.backends.EmailBackend')
...
class LoginView(View):
    ...
    def post(self, request):
        ...
        login(request, user, backend='infra.accounts.backends.EmailBackend')
