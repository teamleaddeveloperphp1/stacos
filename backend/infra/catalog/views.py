...
from infra.catalog.catalog import CATALOG, get_service
from infra.catalog.models import ServiceInterest
...
class DashboardView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        for service in CATALOG:
            url = reverse(service.url_name) if service.available else reverse('catalog:service', args=[service.slug])
